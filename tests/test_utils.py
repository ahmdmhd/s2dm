...
def test_required_input_value_definition_uses_non_null_without_default() -> None:
    ...
    assert directive_utils.is_required_input_value_definition(arguments["required"])
    assert not directive_utils.is_required_input_value_definition(arguments["nonNullWithDefault"])
    assert not directive_utils.is_required_input_value_definition(arguments["optional"])
...
def test_directive_definition_superset_allows_optional_added_arguments_and_locations() -> None:
    ...
    assert directive_utils.is_directive_definition_superset(superset, subset)
    assert not directive_utils.is_directive_definition_superset(subset, superset)
...
def test_directive_definition_superset_rejects_required_added_arguments() -> None:
    ...
    assert not directive_utils.is_directive_definition_superset(candidate, subset)
...
def test_scalar_definition_superset_compares_applied_directive_arguments() -> None:
    ...
    assert directive_utils.is_scalar_definition_superset(superset, subset)
    assert not directive_utils.is_scalar_definition_superset(conflicting, subset)
